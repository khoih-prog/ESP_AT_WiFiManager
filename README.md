...
## Prerequisite
 ...
 6. [`Arduino SAMD core 1.8.7+`](https://www.arduino.cc/en/Guide/ArduinoM0) for SAMD ARM Cortex-M0+ boards  (Nano 33 IoT, etc.).
...
### File [ConfigOnSwitch](examples/ConfigOnSwitch/ConfigOnSwitch.ino)
...
### File [defines.h](examples/ConfigOnSwitch/defines.h)
